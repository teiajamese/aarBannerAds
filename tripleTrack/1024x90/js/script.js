...
tl.from('div.train1 .train',2,{ display:'none',width:'2px', left:'79.7%',bottom:0,ease: Power1.easeOut});
...
tl.to('div.content p span',.5,{display:'inline-block',opacity:1});


tl.from('div.train3 .train',1.6,{display:'none', width:'2px', left:'69%',bottom:0,ease: Power1.easeOut});
